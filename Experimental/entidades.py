class Cajero() :
    def __init__(self, env: object, velocidad_escaneo=0.1):
    ...
    def llamar_cliente(self) :
        self.artículos_escaneados = 0
        self.cliente_actual = self.fila_clientes[0]
        del self.fila_clientes[0]
...
class Cliente() :
    def __init__(self, env: object, tipo_cliente: str):
        self.environment = env
        self.id_cliente = 0
